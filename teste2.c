...
#define MAX_CONTAS 10 // Change this value according to your needs
...
int main()
{
    ...
    while (1)
    {
        ...
        case 1: ;
            ...
            // Find an empty slot in the array to store the account
            int i;
            for (i = 0; i < MAX_CONTAS && contas[i] != NULL; i++) {}

            // Check if there's space for a new account
            if (i < MAX_CONTAS)
            {
            ...
            else
            {
                ...
                free(minha_conta); // Free memory if no space is available
            }
            break;
        case 2:
